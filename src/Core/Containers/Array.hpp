...
struct Array
{
    ...
    // ==========================================================
    [[nodiscard]] constexpr reference At( size_type const pos ) { return at( pos ); }
    // ==========================================================
    /// @brief Access specified element with bounds checking.
    /// @param pos Position of the element to return
    /// @return Reference to the requested element.
    // ==========================================================
    [[nodiscard]] constexpr const_reference At( size_type const pos ) const { return at( pos ); }
    ...
    // ============================================
    [[nodiscard]] constexpr reference Front() { return front(); }
    // ============================================
    /// @brief Access the first element.
    /// @return Reference to the first element.
    // ============================================
    [[nodiscard]] constexpr const_reference Front() const { return front(); }

    // ===========================================
    /// @brief Access the last element.
    /// @return Reference to the last element.
    // ===========================================
    [[nodiscard]] constexpr reference Back() { return back(); }
    // ===========================================
    /// @brief Access the last element.
    /// @return Reference to the last element.
    // ===========================================
    [[nodiscard]] constexpr const_reference Back() const { return back(); }
    ...
    // ===============================================================================================================
    [[nodiscard]] constexpr pointer data() { return data(); }
    // ===============================================================================================================
    /// @brief Direct access to the underlying contiguous storage.
    /// @return Pointer to the underlying element storage.\n
    ///         For non-empty containers, the returned pointer compares equal to the address of the first element.
    // ===============================================================================================================
    [[nodiscard]] constexpr const_pointer data() const { return data(); }
    ...
    /// @return Iterator to the beginning.
    // =======================================
    [[nodiscard]] const_iterator begin() const { return begin(); }
    // =======================================
    /// @return Iterator to the beginning.
    // =======================================
    ...
    /// @return Iterator to the end.
    // =================================
    [[nodiscard]] const_iterator end() const { return end(); }
    // =================================
    /// @return Iterator to the end.
    // =================================
    [[nodiscard]] const_iterator CEnd() const { return cend(); }

    // ===============================================
    /// @return Reverse iterator to the beginning.
    // ===============================================
    [[nodiscard]] iterator RBegin() { return rbegin(); }
    // ===============================================
    /// @return Reverse iterator to the beginning.
    // ===============================================
    [[nodiscard]] const_iterator RBegin() const { return rbegin(); }
    // ===============================================
    /// @return Reverse iterator to the beginning.
    // ===============================================
    [[nodiscard]] const_iterator RCBegin() const { return rcbegin(); }

    // =========================================
    /// @return Reverse iterator to the end.
    // =========================================
    [[nodiscard]] iterator REnd() { return rend(); }
    // =========================================
    /// @return Reverse iterator to the end.
    // =========================================
    [[nodiscard]] const_iterator REnd() const { return rend(); }
    // =========================================
    /// @return Reverse iterator to the end.
    // =========================================
    [[nodiscard]] const_iterator RCEnd() const { return rcend(); }
    ...
    // =============================================================
    [[nodiscard]] constexpr bool empty() const { return empty(); }
    // =================================================
    /// @return Number of elements in the container.
    // =================================================
    [[nodiscard]] constexpr size_type size() const { return size(); }
    // ======================================================================
    /// @return Maximum number of elements the container is able to hold.
    // ======================================================================
    [[nodiscard]] constexpr size_type MaxSize() const { return max_size(); }
    ...
    // =================================================================
    void Fill( const_reference value ) { fill( value ); }
    // ==========================================================================
    /// @brief Exchanges the contents of the container with those of 'other'.
    /// @param other Container to exchange the contents with
    // ==========================================================================
    void Swap( Array& other ) { swap( other.std ); }
