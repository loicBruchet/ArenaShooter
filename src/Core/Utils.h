...
inline std::vector<String> EmptyRemover(std::vector<String> vect)
{
    std::vector<String> emptyDel;
...
inline std::vector<String> SplitString(String const& toSplit, char8 separator)
{
