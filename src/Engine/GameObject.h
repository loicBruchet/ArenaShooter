...
public:
    ...
    bool HasAllTags(uint32 tags) const;
    bool HasAnyTag(uint32 tags) const;
    uint32 GetTags() const;
    static bool CompareTags(const GameObject& a, const GameObject& b);
    static bool ShareAnyTag(const GameObject& a, const GameObject& b);
