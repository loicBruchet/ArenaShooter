...
inline void GameObject::SetName(cstr name)
{
    m_name = name;
}

inline void GameObject::AddTag(uint32 tag)
{
    m_tags |= tag;
}

inline void GameObject::RemoveTag(uint32 tag)
{
    m_tags &= ~tag;
}

inline void GameObject::SetTags(uint32 tags)
{
    m_tags = tags;
}

inline void GameObject::ClearTags()
{
    m_tags = 0;
}

inline bool GameObject::HasTag(uint32 tag) const
{
    return (m_tags & tag) != 0;
}

inline bool GameObject::HasAllTags(uint32 tags) const
{
    return (m_tags & tags) == tags;
}

inline bool GameObject::HasAnyTag(uint32 tags) const
{
    return (m_tags & tags) != 0;
}

inline uint32 GameObject::GetTags() const
{
    return m_tags;
}

inline bool GameObject::CompareTags(const GameObject& a, const GameObject& b)
{
    return a.m_tags == b.m_tags;
}

inline bool GameObject::ShareAnyTag(const GameObject& a, const GameObject& b)
{
    return (a.m_tags & b.m_tags) != 0;
}
...
ComponentClass* GameObject::AddComponent()
{
    ...
    {
        ComponentClass::s_list.push_back( new ComponentClass );
